...
"""
    ...
    def get_question(sample) : 
        prompt = f"""
Read the text below and reformulate the question based on its content:

Text: {sample['article']}
Question: {sample['question']}

Please provide your reformulated question without including any tags, comments, or direct references to the text.
"""
