...
3. Your task is to generate a new multiple-choice question that incorporates all of the provided options, reflecting a choice between them. The question should be related to the given context and original question, but it should be rephrased to fit the multiple-choice format.
...
4. When creating your question:
   ...
   - Maintain the original meaning and intent of the provided question and options.
