...
Second half
torchrun --nnodes 1 --nproc_per_node 4 -m llama_recipes.finetuning --enable_fsdp --dataset "custom_dataset" --custom_dataset.file "/gpfs/users/barkallasl/ift/llama-recipes/aya_dataset.py" --model_name "/gpfs/workdir/barkallasl/ift/llama-recipes/model_checkpoints1/fine-tuned-meta-llama/Meta-Llama-3-8B-Instruct" --dist_checkpoint_root_folder model_checkpoints2 --dist_checkpoint_folder fine-tuned --fsdp_config.pure_bf16 --use_fast_kernels --use_wandb
...
accelerate launch --multi_gpu --num_processes=4 run_evals_accelerate.py --model_args="pretrained=meta-llama/Meta-Llama-3.1-8B-Instruct" --custom_tasks community_tasks/arabic_evals.py --tasks examples/tasks/arabic_tasks_0.txt --override_batch_size 8 --save_details --output_dir="./output_arabic_benchmark" --dataset_loading_processes 10
