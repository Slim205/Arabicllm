    ...
    for epoch in range(train_config.num_epochs):
        ...
        with MemoryTrace() as memtrace:  # track the memory usage
            ...
            with profile(train_config,local_rank) as profile_context:
             ...
             #       print('THE LOSS ================ :',loss.detach().float())
              #      print(batch['labels'][batch['labels'].ge(0)])
                            ...
                            if train_config.save_model and eval_epoch_loss < best_val_loss:
                                ...
                                if train_config.use_peft:
                                    ...
                                    if not train_config.use_peft and fsdp_config.checkpoint_type == StateDictType.FULL_STATE_DICT:
                                        ...
                                        print("=====================================================")
                                      #  xx = train_config.dist_checkpoint_root_folder
                                       # train_config.dist_checkpoint_root_folder = train_config.dist_checkpoint_root_folder + str(step)
                                        save_model_and_optimizer_sharded(model, rank, train_config)
                                        if train_config.save_optimizer:
                                            save_model_and_optimizer_sharded(model, rank, train_config, optim=optimizer)
                                            print(" Saving the FSDP model checkpoints and optimizer using SHARDED_STATE_DICT")
                                            print("=====================================================")
                                         #train_config.dist_checkpoint_root_folder = xx
